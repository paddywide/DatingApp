...
/***/ "./src/app/_guards/previent-unsaved-changes.guard.ts":
/*!***********************************************************!*\
  !*** ./src/app/_guards/previent-unsaved-changes.guard.ts ***!
  \***********************************************************/
...
/* harmony import */ var _guards_previent_unsaved_changes_guard__WEBPACK_IMPORTED_MODULE_27__ = __webpack_require__(/*! ./_guards/previent-unsaved-changes.guard */ "./src/app/_guards/previent-unsaved-changes.guard.ts");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
    ...
    AppModule = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
            ...
            providers: [
                ...
                _guards_previent_unsaved_changes_guard__WEBPACK_IMPORTED_MODULE_27__["PreventUnsavedChanges"]
            ],
            bootstrap: [
                _app_component__WEBPACK_IMPORTED_MODULE_8__["AppComponent"]
            ]
...
var NavComponent = /** @class */ (function () {
    ...
    NavComponent.prototype.login = function () {
        ...
        this.authService.login(this.model).subscribe(function (next) {
            _this.alertify.success('Logged in successful');
        }, function (error) {
            _this.alertify.error(error);
        }, function () {
            _this.router.navigate(['/members']);
...
/* harmony import */ var _guards_previent_unsaved_changes_guard__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./_guards/previent-unsaved-changes.guard */ "./src/app/_guards/previent-unsaved-changes.guard.ts");
    ...
    { path: '', component: _home_home_component__WEBPACK_IMPORTED_MODULE_0__["HomeComponent"] },
    {
        ...
        children: [
            ...
            { path: 'member/edit', component: _members_member_edit_member_edit_component__WEBPACK_IMPORTED_MODULE_8__["MemberEditComponent"],
                resolve: { user: _resolvers_member_edit_resolver__WEBPACK_IMPORTED_MODULE_9__["MemberEditResolver"] }, canDeactivate: [_guards_previent_unsaved_changes_guard__WEBPACK_IMPORTED_MODULE_10__["PreventUnsavedChanges"]] },
...
module.exports = __webpack_require__(/*! C:\Code\DatingApp\DatingApp-SPA\src\main.ts */"./src/main.ts");
